...
>
    ...
    {{-- loading veil --}}
    <div x-show="loading" x-transition.opacity style="position:absolute; inset:0; display:flex; align-items:center; justify-content:center; background:rgba(244,246,251,.85); font-family:Arial,sans-serif; color:#1B3A6B; font-weight:700; letter-spacing:.5px; z-index:500;">
    ...
    <template x-if="active">
        <div style="position:absolute; right:12px; top:12px; z-index:500; background:#fff; border-radius:10px; padding:14px 16px; width:250px; font-family:Arial,sans-serif; box-shadow:0 6px 24px rgba(0,0,0,.18); border-top:4px solid #1B3A6B;">
