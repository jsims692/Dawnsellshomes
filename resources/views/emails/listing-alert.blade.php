<div style="max-width:600px;margin:0 auto;font-family:Arial,Helvetica,sans-serif;color:#0F1E2E;">
  ...
  <p style="font-size:15px;">{{ $search->name ? $search->name.', new' : 'New' }} homes just hit the market matching your saved search:<br>
  ...
  <div style="border-top:1px solid #DEE6EE;margin-top:18px;padding-top:12px;font-size:11px;color:#8A99AA;line-height:1.7;">
    ...
    You saved this search on dawnsellshomes.com. <a href="{{ url('/alerts/unsubscribe/'.$search->token) }}" style="color:#8A99AA;">Unsubscribe</a></p>
  </div>
</div>
