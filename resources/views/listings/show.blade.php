...
<style>
  ...
  .ld-gallery { display:grid; grid-template-columns:2fr 1fr; gap:8px; border-radius:14px; overflow:hidden; }
  .ld-gallery div { aspect-ratio:3/2; background:#E9EFF3 center/cover no-repeat; }
