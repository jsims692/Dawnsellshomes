...
<section class="section">
  <div class="wrap">
    ...
    <div class="cards3">
      ...
      <div class="c-card"><h3>Homes we&rsquo;ve sold</h3><p>Every pin is a family we helped. Browse {{ \App\Support\TeamStats::mappedSales() }} of our {{ \App\Support\TeamStats::soldTotal() }} sales on the interactive map &mdash; every closing since 2007 &mdash; and see what we&rsquo;ve done on your street. <a href="/sold">See the map &rarr;</a></p></div>
